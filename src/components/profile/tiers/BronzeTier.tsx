...
export const BronzeTier = () => {
  return (
    <View style={styles.content}>
      <Text style={styles.title}>Bronze Member®.</Text>
      <Text style={styles.subtitle}>
        Enjoy these benefits as a Bronze Member®.
      </Text>
      ...
      <View style={styles.rewardsSection}>
        ...
        <Text style={styles.rewardsSubtitle}>
          You are <Text style={styles.pointsHighlight}>40,000</Text> Loyalty Points away from receiving these rewards and benefits
        </Text>
